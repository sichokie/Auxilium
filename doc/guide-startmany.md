...
[From the totum github repo](https://github.com/totum-crypto/totum/blob/master/doc/masternode_conf.md)
...
## What about the totum.conf file?

If you are using a masternode.conf file you no longer need the totum.conf file. The exception is if you need custom settings (thanks oblox). 

## Update totum.conf on server

If you generated a new masternode private key, you will need to update the remote totum.conf files.

Shut down the daemon and then edit the file.

```sudo nano .totum/totum.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote totum.conf file.
...
And compare with the official explorer at http://totumexplorer.coin-server.com <or> dnet.presstab.pw
