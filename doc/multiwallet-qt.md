...
In order to support loading of multiple wallets in totum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is totum.cpp.
...
Changes to totum.cpp
----------------------
totum.cpp is the entry point into totum-qt, and as such, will require some minor modifications to provide hooks for
