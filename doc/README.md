...
- bin/32/totum-qt (GUI, 32-bit) or bin/32/totumd (headless, 32-bit)
- bin/64/totum-qt (GUI, 64-bit) or bin/64/totumd (headless, 64-bit)

### Windows

Unpack the files into a directory, and then run totum-qt.exe.
...
* Ask for help on [BitcoinTalk](https://bitcointalk.org/index.php?topic=1262920.0) or on the [PIVX Forum](http://forum.totum.org/).
* Join one of our Slack groups [PIVX Slack Groups](https://totum.org/slack-logins/).
...
* Discuss on the [BitcoinTalk](https://bitcointalk.org/index.php?topic=1262920.0) or the [PIVX](http://forum.totum.org/) forum.
* Join the [PIVX-Dev](https://totum-dev.slack.com/) Slack group ([Sign-Up](https://totum-dev.herokuapp.com/)).
