Contributing to Totum Core
============================

The Totum Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Totum Core project, and is not to be
confused with overall Totum Network Protocol consensus changes.

Whether a pull request is merged into Totum Core rests with the project merge
...
Patches that change Totum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Totum consensus, it must have been
...
The project leader is the release manager for each Totum Core release.
