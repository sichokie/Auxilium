...
//! These need to be macros, as clientversion.cpp's and totum*-res.rc's voodoo requires it
...
/**
 * totumd-res.rc includes this file, but it cannot cope with real c++ code.
