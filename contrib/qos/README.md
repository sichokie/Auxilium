...
This means one can have an always-on totumd instance running, and another local totumd/totum-qt instance which connects to this node and receives blocks from it.
