...
RESOURCES += src/qt/totum.qrc src/qt/totum_locale.qrc

TRANSLATIONS += src/qt/locale/totum_bg.ts \
                src/qt/locale/totum_de.ts \
                src/qt/locale/totum_en.ts \
                src/qt/locale/totum_es.ts \
                src/qt/locale/totum_fi.ts \
                src/qt/locale/totum_fr.ts \
                src/qt/locale/totum_it.ts \
                src/qt/locale/totum_ja.ts \
                src/qt/locale/totum_pl.ts \
                src/qt/locale/totum_pt.ts \
                src/qt/locale/totum_ru.ts \
                src/qt/locale/totum_sk.ts \
                src/qt/locale/totum_sv.ts \
                src/qt/locale/totum_vi.ts \
                src/qt/locale/totum_zh_CN.ts \
                src/qt/locale/totum_zh_TW.ts
